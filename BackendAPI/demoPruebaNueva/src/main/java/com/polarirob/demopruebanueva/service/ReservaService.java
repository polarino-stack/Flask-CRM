...
public class ReservaService {
    ...
    public Reserva crearReserva(CrearReservaRequest request) {
        ...
        boolean existeSolapamiento = !reservaRepository
                .findReservasSolapadas(mesa.getId(), fechaReserva, horaInicio, horaFin)
                .isEmpty();
        ...
        Reserva reserva = new Reserva(mesa, request.getNombreCliente().trim(), request.getNumeroPersonas(), inicio);
